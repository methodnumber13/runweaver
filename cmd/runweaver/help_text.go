...
Flags:
  ...
  --classifier-provider provider      OpenCode provider id for AI classification (default openai-compatible)
  --classifier-runtime id             AI classifier runtime: opencode, codex, or claude
  --classifier-model model            optional runtime model override
...
`
  ...
  runweaver doctor model --repo <path> --provider openai-compatible
...
`
	case "doctor model":
		return `Usage:
  runweaver doctor model --repo <path> [--provider openai-compatible] [--model model] [--base-url url]

Flags:
  --repo path       repository path (default ".")
  --provider id     OpenCode provider id (default openai-compatible)
...
Flags:
  ...
  --provider id          OpenCode provider id for model preflight (default openai-compatible)
